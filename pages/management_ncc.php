    ...
    <div class="container">
      <div class="row">
        <div class="col-12 d-flex justify-content-end gap-2">
          <a href="import.php">
            <button class="btn btn-success mt-2 mb-2"><i class="fa-solid fa-plus"></i> Thêm nhà cung cấp</button>
          </a>
        </div>
      </div>
    </div>
          ...
          <tbody>
            ...
            foreach ($suppliers as $index => $supplier) {
              ...
              echo "<td class='align-middle h-100 d-flex gap-1 justify-content-center align-items-center'>
                                <button id='btn-detail' onclick='openDetail(\"" . $supplier['codeNCC'] . "\")' type='button' class='btn btn-secondary'><i class='fa-solid fa-pen-to-square'></i></button>
                                <button id='btn-detail' onclick='openDetail(\"" . $supplier['codeNCC'] . "\")' type='button' class='btn btn-danger'><i class='fa-solid fa-trash'></i></button>
                            </td>";
              echo "</tr>";
            }
            ?>
