...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Get data from form
    $id = $_POST['id'];
    $updatedNameCustomer = $_POST['updatedNameCustomer'];

    // Tạo dữ liệu mới từ form
    $newData = [
        'nameCustomer' => $updatedNameCustomer
    ];

    // Cập nhật dữ liệu mới vào file JSON
    updateJsonFileById('../' . CUSTOMER_JSON_LINK, $id, $newData);

    echo json_encode(['success' => true, 'message' => 'Cập nhật khách hàng thành công!']);
} else {
